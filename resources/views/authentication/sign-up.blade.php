...
@section('contents')
    <div class="min-h-screen flex flex-col items-center justify-center px-4 py-8 bg-gray-900">

        <!-- Card -->
        <div class="w-full max-w-lg p-6 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800 space-y-6">
