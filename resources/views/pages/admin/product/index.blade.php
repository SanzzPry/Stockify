            ...
            <div class="flex gap-2 mt-2 sm:mt-0 sm:ml-auto">
                <form action="{{ route('product.import') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <input type="file" name="import_file"
                        class="text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg cursor-pointer dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600"
                        required>
                    <button
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        @foreach ($products as $item)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    @if ($item->image)
                                        <img src="{{ asset('storage/' . $item->image) }}" alt="{{ $item->name }}"
                                            class="w-16 h-16 object-cover rounded shadow border border-gray-200 dark:border-gray-700" />
                                    @else
                                        <div
                                            class="w-16 h-16 flex items-center justify-center bg-gray-100 text-gray-400 rounded border border-dashed border-gray-300 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    ...
                                    <button type="button" id="deleteProductButton"
                                        data-drawer-target="{{ $item->id }}"
                                        data-drawer-show="{{ $item->id }}"
                                        aria-controls="{{ $item->id }}" data-drawer-placement="right"
                            ...
                            <div id="{{ $item->id }}"
                                ...
                                <h3 class="mb-6 text-lg text-gray-500 dark:text-gray-400">Are you sure you want to delete
                                    this product?
                                </h3>
...
<div id="drawer-create-product-default"
    class="fixed top-2 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800"
    tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
    <h5 id="drawer-label"
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="sku" id="sku"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Type product sku" required="">
            </div>
            <div>
                ...
                <input type="text" name="purchase_price" id="purchase_price"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Type product purchase price" required="">
            </div>
            <div>
                ...
                <input type="text" name="selling_price" id="selling_price"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Type product selling price" required="">
            </div>
            <div>
