        ...
        <div class="mb-4">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <form action="{{ route('stock.update') }}" method="POST" enctype="multipart/form-data"
                    class="flex flex-col sm:items-end mt-4 sm:mt-0">
                    @csrf
                    <label for="stock_minimum" class="mb-1 text-xl font-semibold text-gray-900 dark:text-white">Change
                        Minimum Stock</label>
                    <div class="flex items-center gap-2">
                        <input type="number" name="stock_minimum" value="{{ $minimumStock }}"
